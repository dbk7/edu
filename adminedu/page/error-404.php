<div class="content custom-scrollbar">
    ...
    <div id="error-404" class="d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="content">
            ...
            <div class="message h4 text-center text-muted">Maaf, halaman tidak ditemukan</div>
            ...
            <a class="back-link d-block text-center text-primary" href="index.php">Kembali ke beranda</a>
